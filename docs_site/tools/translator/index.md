...
Land here from the pipeline strip or the repository map and leave knowing what translator does, what it takes in, what it hands on, and where to go next.
...
<!-- ASSEMBLER: source="atrium-translator/README.md" section="preamble (before the first `##`)" depth=— -->
### What it does
...
<!-- ASSEMBLER: source="atrium-translator/README.md" section="## ✨ Features" depth=3 -->
### ✨ Features

<!-- ASSEMBLER: source="atrium-translator/README.md" section="## 📄 License & Citation" depth=3 -->
### 📄 License & Citation

<!-- ASSEMBLER: source="atrium-translator/README.md" section="## 🙏 Acknowledgements" depth=3 -->
### 🙏 Acknowledgements
