...
Understand why nlp-enrich is shaped the way it is, in the order it happened.

## Sources

| Source | Section | Depth | Treatment |
|---|---|---|---|
| `atrium-nlp-enrich/agent_dev_logs/DEVLOG.md` | the whole timeline | 2 | **derived**, never hand-written (17,532 B) |
| `atrium-nlp-enrich/agent_dev_logs/` | 8 digests · 8 plans | — | **not published** — linked to GitHub only |


## Outline

<!-- ASSEMBLER: source="atrium-nlp-enrich/agent_dev_logs/DEVLOG.md" section="*" depth=2 note="derive timeline" -->
### Timeline

### The record

<!-- 8 digests and 8 plans stay in-repo; link, do not publish. -->
