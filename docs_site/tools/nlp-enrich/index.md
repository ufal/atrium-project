...
Land here from the pipeline strip or the repository map and leave knowing what nlp-enrich does, what it takes in, what it hands on, and where to go next.
...
<!-- ASSEMBLER: source="atrium-nlp-enrich/README.md" section="preamble (before the first `##`)" depth=— -->
### What it does
...
<!-- ASSEMBLER: source="atrium-nlp-enrich/README.md" section="## TEITOK XML — Unified Output Format" depth=3 -->
### TEITOK XML — Unified Output Format

<!-- ASSEMBLER: source="atrium-nlp-enrich/README.md" section="## Acknowledgements 🙏" depth=3 -->
### Acknowledgements 🙏
