...
Find what changed in llm-enrich between two versions, and link to a single release.
...
<!-- ASSEMBLER: source="atrium-llm-enrich/CONTRIBUTING.md" section="## 📦 Release History" depth=3 note="transpose: 3-col table -> one ### per version" -->
### Releases
