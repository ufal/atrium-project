...
Land here from the pipeline strip or the repository map and leave knowing what llm-enrich does, what it takes in, what it hands on, and where to go next.
...
<!-- ASSEMBLER: source="atrium-llm-enrich/README.md" section="preamble (before the first `##`)" depth=— -->
### What it does
...
<!-- ASSEMBLER: source="atrium-llm-enrich/README.md" section="## Backends at a glance" depth=3 -->
### Backends at a glance

<!-- ASSEMBLER: source="atrium-llm-enrich/README.md" section="## Acknowledgements 🙏" depth=3 -->
### Acknowledgements 🙏
