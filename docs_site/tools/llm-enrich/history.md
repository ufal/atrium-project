...
Understand why llm-enrich is shaped the way it is, in the order it happened.
...
<!-- ASSEMBLER: source="atrium-llm-enrich/agent_dev_logs/DEVLOG.md" section="*" depth=2 note="derive timeline" -->
### Timeline

### The record

<!-- 5 digests and 5 plans stay in-repo; link, do not publish. -->
